...
mixin _$BasicProfileState {
  ...
  /// Create a copy of BasicProfileState
...
class _$BasicProfileStateCopyWithImpl<$Res, $Val extends BasicProfileState>
  ...
  $Res call({
    ...
    Object? birthDayController = null,
    ...
    return _then(_value.copyWith(
      ...
      birthDayController: null == birthDayController
...
class _$BasicProfileStateImpl implements _BasicProfileState {
  ...
  @override
  String toString() {
    return 'BasicProfileState(isLoading: $isLoading, isSuccessful: $isSuccessful, isFailed: $isFailed, noUse: $noUse, isContinueEnabled: $isContinueEnabled, isSaveDetailsEnable: $isSaveDetailsEnable, startValidation: $startValidation, errorMessage: $errorMessage, profileImage: $profileImage, user: $user, appStateNotifier: $appStateNotifier, selectedDate: $selectedDate, coreRepository: $coreRepository, authRepository: $authRepository, userRepository: $userRepository, fullNameController: $fullNameController, birthDayController: $birthDayController, errorFullName: $errorFullName, showPermissionDialog: $showPermissionDialog)';
  }
...
abstract class _BasicProfileState implements BasicProfileState {
  const factory _BasicProfileState(
      ...
      required final bool isContinueEnabled,
      ...
      required final TextEditingController birthDayController,
