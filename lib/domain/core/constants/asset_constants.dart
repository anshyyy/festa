class AssetConstants {
  ...
  static const vectorsFolder = '${assetFolder}vectors/';
  static const gifFolder = '${assetFolder}gif/';
  ...
  static const graphIcon = '${vectorsFolder}ac.svg';
  static const coinIcon = '${vectorsFolder}coings.svg';

  static const compassIcon = '${vectorsFolder}compass.svg';
  ...
  static const upTickRightIcon = "${vectorsFolder}arrow_up.svg";
  ...
  static const supportIcon2 = '${vectorsFolder}support2.svg';
  static const starIcon2 = '${vectorsFolder}star2.svg';
  ...
  static const bubbleLoader = '${gifFolder}bubble-loader.gif';

  static const festaIconPng = '${vectorsFolder}festa-icon.png';
  static const festaIconSvg = '${vectorsFolder}festa-icon.svg';

  static const googleIcon = '${vectorsFolder}google-logo.svg';
  static const appleIcon = '${vectorsFolder}apple-logo.svg';
  ...
  static const qrDemo = '${vectorsFolder}qr-demo.png';
  ...
  static const hamBurgerMenu = '${vectorsFolder}hamburger-menu-icon.svg';
