...
class BasicProfileScreenConstants {
  ...
  static String detailsTrailingText =
      "Festa’s only for the real ones, Let's have a quick check!";
...
class ProfileAndSettingsScreenConstants {
  ...
  static String rewardsFromFriends = 'Rewards from friends';
  static String blockedAccount = 'Blocked Accounts';
  static String privacy = 'Privacy';
  static String blockedUsers = 'Blocked Users';
  static String tellAFriend = 'Tell a friend';
  static String help = 'Help';
  static String shareAndEarn = 'Share and earn';
  static String shareExpierence = 'Share this experiences, and earn discounts'; 
