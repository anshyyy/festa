...
class BookedTicketDetailsDto with _$BookedTicketDetailsDto {
  const factory BookedTicketDetailsDto({
    ...
    @JsonKey(name: 'paymentMethod', defaultValue: '') required String paymentMethod,
    @JsonKey(name: 'transactionId', defaultValue: '') required String transactionId,
    @JsonKey(name: 'bookingReference', defaultValue: '') required String bookingReference,
    @JsonKey(name: 'paymentAmount', defaultValue:'') required String paymentAmount,
