...
mixin _$Period {
  @JsonKey(name: 'open')
  OpenClose get open => throw _privateConstructorUsedError;
  @JsonKey(name: 'close')
  OpenClose get close => throw _privateConstructorUsedError;
...
abstract class $PeriodCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'open') OpenClose open,
      @JsonKey(name: 'close') OpenClose close});

  $OpenCloseCopyWith<$Res> get open;
  $OpenCloseCopyWith<$Res> get close;
}
...
class _$PeriodCopyWithImpl<$Res, $Val extends Period>
  ...
  @pragma('vm:prefer-inline')
  $OpenCloseCopyWith<$Res> get open {
    return $OpenCloseCopyWith<$Res>(_value.open, (value) {
  ...
  @pragma('vm:prefer-inline')
  $OpenCloseCopyWith<$Res> get close {
    return $OpenCloseCopyWith<$Res>(_value.close, (value) {
...
abstract class _Period implements Period {
  const factory _Period(
      {@JsonKey(name: 'open') required final OpenClose open,
      @JsonKey(name: 'close') required final OpenClose close}) = _$PeriodImpl;
