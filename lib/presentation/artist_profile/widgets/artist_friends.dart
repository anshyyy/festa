          ...
          children: [
            CustomTextField(
              ...
              contentPadding:
               ...
               onChanged: (value) {
                EasyDebounce.debounce('artist-friends-search', 
                const Duration(milliseconds: 500),
                 () {
                  context.read<ArtistCommunityCubit>().searchArtistFriends(page: 1);
                 });
              },
              suffixIcon: state.friendsSearchController.text.isNotEmpty
                  ? GestureDetector(
                      onTap: () {
                        // context.read<ArtistCommunityCubit>().clearSearch();
                      },
            ...
            Expanded(
              child: state.isFriendsFetching
                  ? const UserSocialShimmer()
                  : state.artistFriends!.users.isNotEmpty
                      ? ListView.builder(
