...
class EventCard extends StatelessWidget {
  ...
  const EventCard(
      ...
      required this.ratings, required this.date, required this.posters});
            ...
            children: [
              CarouselSlider.builder(
                  ...
                  options: CarouselOptions(
                    ...
                    onPageChanged: (index, reason) {
                      context.read<HomeCubit>().onCarouselChange(index: index);
                    },
                  )),
              SizedBox(
                height: 1.h,
              ...
              Row(
                children: [
                  ...
                  Text(
                    '${AppConstants.rupees}${price.toStringAsFixed(0)}',
