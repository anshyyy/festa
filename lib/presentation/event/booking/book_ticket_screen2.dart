...
import 'widgets/select_ticket_tabs.dart';
...
class BookTicketScreen2 extends StatelessWidget {
  final int eventId;
  const BookTicketScreen2({super.key, required this.eventId});
          ...
          child: state.isLoading
              ...
              : Scaffold(
                  bottomNavigationBar: BottomBookingBar(
                    ...
                    onClick: () {
                      AnalyticsService().logEvent(eventName: 'view tickets', paras: {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (state.nonEmptyIndexes.length > 1)
                              SelectTicketTabs(),
                            SizedBox(height: 1.h),
                            ...state.ticketLists[state.selectedTab].map((e) {
                              return Padding(
                                padding:
