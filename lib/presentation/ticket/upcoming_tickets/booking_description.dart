            ...
            children: [
              AnimatedSwitcher(
                ...
                child: ticketDetails.showTicketDetails
                    ...
                    : QrViewer(
                        bookingReferenceId: ticketDetails.bookingReference,
                      ),
              ),
              Positioned(
                bottom: 0,
                ...
                child: Column(
                  ...
                  children: [
                    state.isShareEnabled && !ticketDetails.showTicketDetails
                        ? GestureDetector(
                            onTap: () {
                              AnalyticsService()
                                  .logEvent(eventName: 'share_ticket', paras: {
                                'ticket_id': state.historyTicket!.id.toString(),
                              });
                    ...
                    state.isShareEnabled
                        ? GestureDetector(
                            onTap: () => context
                                .read<TicketCubit>()
                                .showTransactionDetails(
                                    id: ticketDetails.id,
                                    isHistory: state.shoHistoryTicketDetails),
                            child: Container(
                              height: 10.w,
                              width: 10.w,
