                              ...
                              children: [
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return SettingTile(
                                        isEmpty: currentMenu.navigationRoute ==
                                ...
                                SizedBox(height: 2.h),
                                SettingTile(
                                    prefixIcon: AssetConstants.supportIcon2,
                                    label: 'Support',
                                    suffixIcon: AssetConstants.arrowRight,
                                    onTap: () async {
                                ...
                                SettingTile(
                                    prefixIcon: AssetConstants.starIcon2,
                                    label: 'Follow us on Instagram',
                                    suffixIcon: AssetConstants.upRightArrows,
                                    onTap: () {
                                      launchUrl(
                                        Uri.parse(
                                            'https://www.instagram.com/festaworldofficial'),
